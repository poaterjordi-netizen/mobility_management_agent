...
| ID | 工作项 | 验收 |
| --- | --- | --- |
| WX-001 | 项目骨架/API client | 共用后端契约 |
| WX-002 | 微信登录 | 服务端 code 交换与对象授权 |
| WX-003 | 行程/建议/证据 | 小屏核心闭环 |
| WX-004 | 上传 | 隐私和生命周期 |
| WX-005 | 订阅消息 | 用户授权、幂等、取消 |
| WX-006 | 合法域名/备案 | 严格模式 |
| WX-007 | 真机验收 | Android/iPhone 冷启动 |
| WX-008 | 体验版发布 | 版本、run/audit 记录 |
